...
mkdir -p "$PROJECT_DIR/skills/verifier/graphrag_validation"
mkdir -p "$PROJECT_DIR/skills/verifier/evidence_audit"
mkdir -p "$PROJECT_DIR/skills/verifier/task_relevance_audit"
mkdir -p "$PROJECT_DIR/skills/updater"
mkdir -p "$PROJECT_DIR/skills/updater/daily_update"
